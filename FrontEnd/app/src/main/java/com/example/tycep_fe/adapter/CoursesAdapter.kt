...
import com.example.tycep_fe.databinding.CourseItemBinding
...
class CoursesAdapter (private val courses: Set<Curso>, private val context: Context): RecyclerView.Adapter<CoursesAdapter.CoursesViewHolder>() {
    ...
    inner class CoursesViewHolder(private val binding:CourseItemBinding): RecyclerView.ViewHolder(binding.root){
