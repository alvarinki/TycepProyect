...
class ShowFaltasAdapter(private val faltas:LinkedHashSet<Falta>, private val alumnoViewModel: AlumnoViewModel, private val context: Context): RecyclerView.Adapter<ShowFaltasAdapter.ItemViewHolder>() {
